...
const orders = [
    {
        ...
        image: "https://m.media-amazon.com/images/I/51BJSnsM8iL._UF1000,1000_QL80_.jpg",
    ...
    },
    {
        ...
        author: "Rachel Vincent",
        image: "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1255722532i/6763961.jpg",
    ...
    return (
        <Box sx={{ padding: 4 }}>
            ...
            {orders.map((order, index) => (
                <Box key={index} sx={{ marginBottom: 4, padding: 2, backgroundColor: "#f9f9f9", borderRadius: 2 }}>
                            ...
                            >
                                {steps.map((label, stepIndex) => (
                                    <Step key={stepIndex}>
                                        <StepLabel
                                            StepIconComponent={() => (
                                                <CustomStepIcon isActive={stepIndex === order.currentStep - 1} />
                                            )}
                                        >
